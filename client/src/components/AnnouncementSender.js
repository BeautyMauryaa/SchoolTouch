      ...
      >
        ...
        <div className="md:col-span-2 flex justify-between items-center">
          ...
          >
            {isEditing ? (
              <>
                <FaEdit className="inline-block mr-2" /> Update Announcement
              </>
            ) : (
              <>
                <FaPlus className="inline-block mr-2" /> Send Announcement
              </>
            )}
          </button>
          {isEditing && (
            <button
              type="button"
              onClick={resetForm}
              className="bg-gray-500 text-white py-2 px-4 rounded-md hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-opacity-50"
            >
              Cancel Edit
            </button>
          )}
