  ...
  const handleSearch = async () => {
    ...
    try {
      const res = await axios.get(
        `${API_BASE_URL}/students?search=${searchQuery}&class=${filterClass}`,
        { headers },
      );
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <form
        ...
        className="bg-white p-6 rounded-lg shadow-md mb-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4"
      >
        <div>
          <label>Name</label>
          <input
